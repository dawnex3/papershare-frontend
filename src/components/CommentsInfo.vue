...
<script>
    ...
    export default {
        ...
        mounted() {
            this.$axios.get('http://127.0.0.1:4523/m1/2678340-0-default/api/papers',
                {
                    params: {
                ...
                res => {
                    ...
                    this.items = res.data.data[0].comments
                    var Comments = JSON.parse(JSON.stringify(this.items))
                    ...
                    Comments.forEach(comment => {
                        ...
                        coment.name = comment.user_id
                        coment.comment = comment.text
